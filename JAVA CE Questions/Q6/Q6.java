...
class square extends figure
{
	...
	void volume()
	{
		System.out.println("Square is 2D figure, Volume is not applicable");
	}
}
class triangle extends figure
{
	...
	void volume()
	{
		System.out.println("Triangle is 2D figure, Volume is not applicable");
	}
}
class rectangle extends figure
{
	...
	void volume()
	{
		System.out.println("Rectangle is 2D figure, Volume is not applicable");
	}
}
